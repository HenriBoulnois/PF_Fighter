          ...
          return (
            <div className='flex flex-column'>
             ...
             <div className='basis-3/4 flex-row text-center border pt-3 pb-3 rounded'>
                ...
                <div>
                  <Link passHref={true} href="/creation/character"><button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Personnage</button></Link>
                </div>
              </div>
